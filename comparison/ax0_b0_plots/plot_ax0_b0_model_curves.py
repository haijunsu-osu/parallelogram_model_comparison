...
PLOT_SPECS = [
    ("uy", r"$u_y$", "uy_vs_Ay_all_models_Ax0_B0.png"),
    ("ux", r"$u_x$", "ux_vs_Ay_all_models_Ax0_B0.png"),
    ("phi", r"$\phi$ (rad)", "phi_vs_Ay_all_models_Ax0_B0.png"),
]

ERROR_PLOT_SPECS = [
    ("uy", r"Error in $u_y$ (%)", "uy_error_pct_vs_Ay_all_models_Ax0_B0.png"),
    ("ux", r"Error in $u_x$ (%)", "ux_error_pct_vs_Ay_all_models_Ax0_B0.png"),
    ("phi", r"Error in $\phi$ (%)", "phi_error_pct_vs_Ay_all_models_Ax0_B0.png"),
]
